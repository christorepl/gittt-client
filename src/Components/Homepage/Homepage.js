...
class Homepage extends React.Component {
    ...
    render() {
        ...
        <div className="info">
            ...
            <p>You can manually add games, import games from <a href="https://www.boardgameatlas.com/" target="_blank" rel="noopener noreferrer">BGA lists</a>, use suggested games, or use randomly selected games!</p>
        </div>
